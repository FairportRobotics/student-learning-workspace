...
public class Kale extends AbstractRobot implements GiveMeLightSensor,
		GiveMeProximitySensor {
	double distance = 0;
	double intensity = 0;
	...
	@Override
	public void tick() {
		if (intensity > Master.MAX_INTENSITY && distance < Master.MIN_DISTANCE)
